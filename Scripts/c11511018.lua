...
function c11511018.ntop(e,tp,eg,ep,ev,re,r,rp,c)
	--dec lv
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(11511018,4))
    e1:SetCategory(CATEGORY_LVCHANGE)
...
function c11511018.filterM1(c,tp)
	return c:IsFaceup() and c:IsSetCard(0xff) and c:GetLevel()>0 and Duel.IsExistingTarget(c11511018.filterM2,tp,LOCATION_MZONE,0,1,c)
end
