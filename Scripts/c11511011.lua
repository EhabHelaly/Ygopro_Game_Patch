...
function c11511011.filterM1(c,tp)
	return c:IsFaceup() and c:IsSetCard(0xff) and c:GetLevel()>0 and Duel.IsExistingTarget(c11511011.filterM2,tp,LOCATION_MZONE,0,1,c)
end
...
function c11511011.targetM(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c11511011.filterM1,tp,LOCATION_MZONE,0,1,nil,tp)  end
    	 ...
    	 e:GetHandler():RegisterFlagEffect(11511011,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,0,1)
 end
