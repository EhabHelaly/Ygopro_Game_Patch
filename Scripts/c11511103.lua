...
function c11511103.spfilter1(c,e,tp)
	return c:IsSetCard(0xfe) and c:IsAbleToHandAsCost() and Duel.IsExistingMatchingCard(c11511103.spfilter2,tp,LOCATION_DECK,0,1,nil,e,tp,c:GetLevel(),c:GetRace())
end
