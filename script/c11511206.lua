...
function c11511206.initial_effect(c)
	...
	e1:SetCondition(c11511206.con)
	e1:SetTarget(c11511206.sptg)
	e1:SetOperation(c11511206.spop)
	c:RegisterEffect(e1)

end
function c11511206.con(e,tp,eg,ep,ev,re,r,rp)
	local at=Duel.GetAttackTarget()
	return at:IsControler(tp) and at:IsFaceup() and at:IsSetCard(0xffd)
end
function c11511206.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c11511206.spop(e,tp,eg,ep,ev,re,r,rp)
