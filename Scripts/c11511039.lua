...
function c11511039.filter1(c,e,tp)
	local lv=c:GetLevel()
	return lv>0 and lv~=c:GetOriginalLevel() and c:IsFaceup() and c:IsSetCard(0xff)
	and Duel.IsExistingMatchingCard(c11511039.filter2,tp,LOCATION_DECK,0,1,nil,lv,e,tp)
end
function c11511039.filter2(c,lv,e,tp)
	return c:GetLevel()==lv and c:IsSetCard(0xff) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
